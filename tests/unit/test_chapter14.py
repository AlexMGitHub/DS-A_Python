#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Test solutions to chapter 14 exercises.
...
# Author:       Alex
#
# Purpose:      Runs unit tests on all chapter 14 exercises from "Data
...
import dsa.chapter14_exercises as chap14
...
def test_draw_simple_undirected_graph():
    ...
    """
    assert chap14.draw_simple_undirected_graph()
...
def test_largest_number_of_edges():
    ...
    """
    assert chap14.largest_number_of_edges()
...
def test_draw_adjacency_matrix():
    ...
    undirected graph.
    """
    assert chap14.draw_adjacency_matrix()
...
def test_draw_adjacency_list():
    ...
    2*m = 2*15 = 30 edges.
    """
    assert chap14.draw_adjacency_list()
...
def test_insert_edge_matrix():
    ...
    """
    assert chap14.insert_edge_matrix()
...
def test_insert_edge_list():
    ...
    """
    assert chap14.insert_edge_list()
...
def test_dfs_traversal_matrix():
    ...
    """
    assert chap14.dfs_traversal_matrix()
...
def test_dfs_complete_graph():
    ...
    DFS tree rooted at vertex 1:
        ...
        4
    """
    assert chap14.dfs_complete_graph()
...
def test_bfs_complete_graph():
    ...
    2   3   4
    """
    assert chap14.bfs_complete_graph()
    ...
    c. BFS Sequence: (1, 2 3 4, 6, 5 7, 8)
       ...
       BFS Tree:
             ...
             2  3  4
                 ...
                 8
    """
    assert chap14.traverse_graph_bfs_and_dfs()


def test_transitive_path_edges():
    ...
    """
    assert chap14.transitive_path_edges()
...
def test_topological_ordering():
    ...
    """
    assert chap14.topological_ordering()
...
def test_course_prerequisites():
    ...
    """
    assert chap14.course_prerequisites()
...
def test_directed_djikstra():
    ...
    """
    assert chap14.directed_djikstra()
        ...
        Minimum Spanning Tree T:
                    ...
                    27  /       \  1
                      ...
                      b           f
                         ...
                         c    e       g     h
    """
    assert chap14.draw_prim_jarnik()
...
def test_bridge_to_islands():
    ...
    """
    assert chap14.bridge_to_islands()
