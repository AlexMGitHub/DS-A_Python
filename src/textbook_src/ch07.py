"""Code from chapter 7 of text.

Available at https://github.com/mjwestcott/Goodrich/
"""
...
class _DoublyLinkedBase:
    ...
    class _Node:
        ...
        def __init__(self, element, prev, n_next):  # initialize node's fields
            self._element = element                 # user's element
            self._prev = prev                       # previous node reference
            self._next = n_next                     # next node reference
...
class LinkedQueue:
    ...
    class _Node:
        ...
        def __init__(self, element, n_next):
...
class PositionalList(_DoublyLinkedBase):
    ...
    class Position:
        ...
        def __eq__(self, other):
            """Return True if other is Position representing same location."""
